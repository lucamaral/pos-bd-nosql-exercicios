...
let randmovies = function() {
    ...
    for (let i=0; i < numMovies; i++)  {
        // someoneMovies.push(movies[Math.floor(Math.random() * movies.length)]);
...
let randPerson = function(index) {
    ...
    if (Math.random() > 0.9) {
      person.mother = //names[Math.floor(Math.random() * names.length)]
      {
        firstname: names[Math.floor(Math.random() * names.length)],
        surname: name.lastname,
    ...
    if (Math.random() > 0.8) {
        person.father = //names[Math.floor(Math.random() * names.length)]
        {
          firstname: names[Math.floor(Math.random() * names.length)],
          surname: name.lastname,
